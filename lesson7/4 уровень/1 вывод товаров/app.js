...
function clickHandler(event) {
    ...
    //productsEl.childNodes.forEach(child => productsEl.removeChild(child));
...
function showCategory(category) {
    products[category].forEach(
        item => productsEl.insertAdjacentHTML("beforeend", getProductMarkup(item)));
}
...
function getProductMarkup(product) {
    return `<div class="product">
                ...
                <a href="https://example.com/producs/${product.price}">Подробнее</a>
            </div>`
}
